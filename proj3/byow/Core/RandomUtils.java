...
/**
 * A library of static methods to generate pseudo-random numbers from different distributions
 * (bernoulli, uniform, gaussian, discrete, and exponential). Also includes methods for shuffling an
 * array and other randomness related stuff you might want to do. Feel free to modify this file.
 * <p>
...
public class RandomUtils {
   ...
   * @return a random integer from a discrete distribution: i with probability proportional to
   * frequencies[i]
